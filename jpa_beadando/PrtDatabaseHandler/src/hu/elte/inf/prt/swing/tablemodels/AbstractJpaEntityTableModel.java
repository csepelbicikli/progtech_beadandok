...
public abstract class AbstractJpaEntityTableModel<E extends EntityWithID> extends AbstractTableModel {
    ...
    public AbstractJpaEntityTableModel(String[] columnNames, EntityController<E> controller) {
